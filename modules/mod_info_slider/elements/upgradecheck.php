...
/**
* @package		Info Slider Module for Joomla!
* @author		Pixel Point Creative http://www.pixelpointcreative.com
* @copyright	Copyright (C) 2012 Pixel Point Creative. All rights reserved.
...
class JFormFieldUpgradecheck extends JFormField {
	...
	protected function getLabel()
	{
		...
		//If cURL is supported, check the current version available.
				...
				$version = 1.2;
				$target = 'http://www.pixelpointcreative.com/upgradecheck/infoslider/index.txt';
				$curl = curl_init();
				...
				if ($version < $str)
					...
					<a href="http://www.pixelpointcreative.com/downloads.html" target="_blank">Download Latest Version</a> &nbsp;&nbsp;|&nbsp; &nbsp;<a href="http://www.pixelpointcreative.com/support.html" target="_blank">Get Help</a> &nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.pixelpointcreative.com/changelogs/infoslider.txt" target="_blank">View the Changelog</a></label>';
				...
				echo'<div style="float:left;clear: both;"><img width="180" height="80" border="0" src="../modules/mod_info_slider/elements/logo.png" title="Info Slider" alt="Info Slider"></div>';  
				return 
				$message;
