...
.big-warning b {
	...
	<div id="installer-right">
		...
		<ul class="version-history">
			<li><span class="version">Ver</span> 1.49.15</li>
			<li><span class="version-fixed">Fix</span> The "Robots" configuration was not applied when using the RSForm!Pro specific menu item.</li>
		</ul>
